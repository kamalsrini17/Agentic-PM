...
exports.exampleProducts = void 0;
exports.analyzeSpecificProduct = analyzeSpecificProduct;
exports.analyzeCustomProduct = analyzeCustomProduct;
exports.demonstrateGenericAgenticPM = demonstrateGenericAgenticPM;
const AgenticPMOrchestrator_1 = require("../agents/AgenticPMOrchestrator");
...
exports.exampleProducts = exampleProducts;
// ============================================================================
// DEMONSTRATION FUNCTION
// ============================================================================
function demonstrateGenericAgenticPM() {
    return __awaiter(this, void 0, void 0, function* () {
        const logger = errorHandling_1.Logger.getInstance();
        const orchestrator = new AgenticPMOrchestrator_1.AgenticPMOrchestrator();
        console.log('🚀 Agentic PM Framework - Generic Product Analysis Demo');
        console.log('='.repeat(60));
        // Test integrations first
        console.log('\n🔧 Testing API Integrations...');
        const integrationTests = yield orchestrator.testIntegrations();
        ...
        for (const [productType, productConcept] of productExamples.slice(0, 2)) { // Test first 2 products
            ...
            try {
                ...
                const result = yield orchestrator.runCompleteWorkflow(workflowRequest);
                ...
                console.error(`❌ Analysis failed for ${productConcept.title}:`, error.message);
            }
        }
...
// ============================================================================
function analyzeSpecificProduct(productKey) {
    return __awaiter(this, void 0, void 0, function* () {
        const orchestrator = new AgenticPMOrchestrator_1.AgenticPMOrchestrator();
        ...
        return yield orchestrator.runCompleteWorkflow(workflowRequest);
    });
}
// ============================================================================
// CUSTOM PRODUCT ANALYSIS FUNCTION
// ============================================================================
function analyzeCustomProduct(customProductConcept) {
    return __awaiter(this, void 0, void 0, function* () {
        const orchestrator = new AgenticPMOrchestrator_1.AgenticPMOrchestrator();
